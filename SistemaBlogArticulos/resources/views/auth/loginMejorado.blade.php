                            ...
                            <div class="form-bottom">
                                <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
			                    	...
			                    	<div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="NickName...">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        <a href="{{ url('/register') }}" class="btn btn-success">Registrate ahora!</a>
                                        <a href="{{ url('blogArticulo/principal') }}" class="btn btn-info">Ingresar como invitado!</a>
			                        </div>
