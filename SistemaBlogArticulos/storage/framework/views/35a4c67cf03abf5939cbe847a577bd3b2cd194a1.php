              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    <p><?php echo e(auth()->user()->name); ?> <small>2019</small></p>
                  </li>
                  ...
                  <li class="user-footer">
                    ...
                    <a href="<?php echo e(url('/logout')); ?>" class="btn btn-default btn-flat">Cerrar sesión</a>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo e(url('/blogArticulo/articulo')); ?>"><i class="fa fa-newspaper-o"></i>Articulos</a></li>
